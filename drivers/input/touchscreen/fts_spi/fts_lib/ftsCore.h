...
#define DATA_HEADER                                                            \
	4 /*size in byte of the header loaded with the data in the frambuffer*/
...
#define RELEASE_INFO_SIZE                                                      \
	(EXTERNAL_RELEASE_INFO_SIZE +                                          \
	 8) /*num bytes of release info in sys info (first bytes are external release)*/
/** @}*/

/*RETRY MECHANISM*/
#define RETRY_MAX_REQU_DATA                                                    \
	2 /*Max number of attemps performed when requesting data*/
